...
public class autotestspecimen extends LinearOpMode {
	...
	arm.move(0.4);
	while(arm.getCurrentPosition() < 570)
	    {
		sleep(1);
	    }
	arm.move(0.05);
	rotator.setposition(0.45);
            ...
            // }
	slide.move(0.4);
	while(slide.getCurrentPosition() < 1000)
	    {
		sleep(1);
	    }
	slide.move(0.05);
	...
	slide.move(-0.07);
	arm.move(0.4);
	while(arm.getCurrentPosition() < 770)
	    {
		sleep(1);
	    }
	arm.move(0.05);
...
right_turn_counter(900);
	moveRobot_backward(DRIVE_SPEED,0,20);
            leftFrontDrive.setPower((DRIVE_SPEED));
            rightFrontDrive.setPower((DRIVE_SPEED));
            leftBackDrive.setPower((DRIVE_SPEED));
            rightBackDrive.setPower((DRIVE_SPEED));
            while (distance_back.getDistanceMM() > 80) {
                sleep(1);
            }
            leftFrontDrive.setPower((0));
            rightFrontDrive.setPower((0));
